...
<div class="col-12 col-md-6 p-3 p-md-5 bg-warning text-center"> <img width="360" class="img-fluid" src="../image/pokit-2.png" /><br /> Hai : <?php echo $_SESSION['username'] ?> , status <?php if (getStatus() == 'Online') echo "<input type='submit' class='btn btn-success' name='btnStatus' value='Online'>";
